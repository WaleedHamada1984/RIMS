Attribute VB_Name = "modFinController"
Public GL_Value(12) As Double
Public GLPYC As Double, Ltype As String
Public Function GetNetSalesGL(Catg As String, Yr As Integer, Company As String)
...
Public Function GetTloaderGL(Cond As String, Yr As Integer, Company As String)
Dim Inum As Integer, FldNam As String
    ...
    If tmpRset.RecordCount > 0 Then
       ...
       For Inum = 1 To 12
           ...
           End If
          GL_Value(Inum) = tmpRset.Fields(FldNam)
          GLPYC = tmpRset.Fields("SumOfGBAPYC")
       Next Inum
    End If
    tmpRset.Close
    Set tmpRset = Nothing
...
Public Function GetOverHeadGL(Catg As String, Yr As Integer, Company As String)
Dim Inum As Integer, FldNam As String
    ...
    Set tmpRset = Nothing
End Function
Public Function GetGL12Slots(Cond As String, Yr As Integer, Company As String)
Dim Inum As Integer, FldNam As String
